...
<iframe height="400px" width="100%" src="https://repl.it/repls/EmbarrassedFlashyUsername?lite=true" scrolling="no" frameborder="no" allowtransparency="true" allowfullscreen="true" sandbox="allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-modals"></iframe>
...
The table of contents is auto generated by including the following snippet bellow. 

::: tip
You must remember to include ## so that the toc block can work.
:::
